...
event_dispatcher.register_event("player_move", action_handler.on_player_move)
event_dispatcher.register_event('player_inventory', action_handler.on_get_inventory)
